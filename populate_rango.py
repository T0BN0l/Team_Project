...
def populate():
    action_pages = [
        ...
        {'title': 'Mission: Impossible - Fallout',
         ...
         'thumbnail': 'page_image/mission impossible.png'}
    ]
    ...
    anime_pages = [
        ...
        {'title': 'Ralph Breaks the Internet',
         ...
         'thumbnail': 'page_image/ralph breaks the internet.png'}
    ]
    ...
    documentary_pages = [
        {'title': 'Fantastic Fungi',
         ...
         'thumbnail': 'page_image/fantastic fungi.png'},
        {'title': 'Jackass',
         ...
         'thumbnail': 'page_image/jackass.png'},
        {'title': 'Clarkson\'s Farm',
         ...
         'thumbnail': 'page_image/clarkson farm.png'}
    ]
    ...
    cats = {'Action': {'pages': action_pages, 'views': 128, 'likes': 64,
            ...
            'thriller': {'pages': thriller_pages, 'views': 38, 'likes': 666,
